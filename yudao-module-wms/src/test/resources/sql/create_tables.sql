...
CREATE TABLE IF NOT EXISTS "wms_inventory" (
    ...
    "tenant_id" bigint NOT NULL DEFAULT '0',
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_wms_inventory_sku_warehouse_area" UNIQUE ("sku_id", "warehouse_id", "area_id", "tenant_id", "deleted")
) COMMENT 'WMS 库存表';

CREATE TABLE IF NOT EXISTS "wms_inventory_detail" (
    "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    "sku_id" bigint NOT NULL,
    "warehouse_id" bigint NOT NULL,
    "area_id" bigint NOT NULL DEFAULT '0',
    "quantity" decimal(24, 6) NOT NULL DEFAULT '0',
    "remain_quantity" decimal(24, 6) NOT NULL DEFAULT '0',
